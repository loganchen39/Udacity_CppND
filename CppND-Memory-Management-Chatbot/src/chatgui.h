...
private:
    ...
    // Ligang: use smart pointer as wrapper for automatic memory(resource) management(deallocation).
...
public:
    ...
    // std::unique_ptr<ChatLogic> GetChatLogicHandle() { return _chatLogic; }  // copy, not gonna work.
